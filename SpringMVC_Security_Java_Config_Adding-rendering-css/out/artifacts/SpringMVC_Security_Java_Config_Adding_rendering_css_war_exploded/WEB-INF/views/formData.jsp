...
<a href="${pageContext.request.contextPath}/admin/user-form">&lt; Go Back</a> | <a href="${pageContext.request.contextPath}/user/all-users">Please click here to view all users.</a>
</body>
</html>
